...
const file_fileService_proto_rawDesc = "" +
	"\n" +
	"\x11fileService.proto\x12\x04file\"T\n" +
	"\tUploadReq\x12$\n" +
	...
	"\x04size\x18\x02 \x01(\x04R\x04size25\n" +
	"\x04File\x12-\n" +
	"\x06Upload\x12\x0f.file.UploadReq\x1a\x10.file.UploadResp(\x01B;H\x01Z7github.com/Cheasezz/fileService/proto/fileService/;fileb\x06proto3"
...
var file_fileService_proto_depIdxs = []int32{
	...
	2, // 2: file.File.Upload:output_type -> file.UploadResp
